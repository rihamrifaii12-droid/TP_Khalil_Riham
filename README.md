...
| **Sauter** | Flèche Haut ou `Espace` (Double saut disponible) |
| **Grimper** | Flèches Haut/Bas ou `W` / `S` (sur les échelles) |
| **Tirer** | Touche `F` ou `Entrée` |
| **Redémarrer** | Touche `R` (lors d'un Game Over ou Victoire) |
| **Menu** | Touche `Echap` |
